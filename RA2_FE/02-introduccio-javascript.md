...
> **Nota:** en aquesta unitat només es presenten aquestes possibilitats. El DOM (RA6), els esdeveniments i els formularis (RA5) i l'emmagatzematge (RA3) es treballen amb detall més endavant. De moment n'hi ha prou de saber que el codi s'ha d'incorporar amb `defer`, com es veu a l'apartat 2.
...
| **No tipat** | Una variable pot canviar de tipus durant l'execució | És àgil d'escriure, però cal vigilar els errors de tipus |
